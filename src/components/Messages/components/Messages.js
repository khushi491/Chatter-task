...
import initialBottyMassage from "../../../common/constants/initialBottyMessage";
...
const ME = "me";
const BOT = "bot";
const initialMassage = {
  message: initialBottyMassage,
  id: Date.now(),
  user: BOT,
};
...
function Messages() {
  ...
  const [messages, setMessages] = useState([initialMassage]);
